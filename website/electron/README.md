...
Native macOS app wrapping the KiroClaw web dashboard. Automatically starts `kiroclaw gateway` and connects to `localhost:7777`.
...
1. An SSH tunnel forwarding port 7777 from the remote host:
   ```bash
   ssh -L 7777:localhost:7777 YOUR_HOST.corp.amazon.com
   ```
