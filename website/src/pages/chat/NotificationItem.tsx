  ...
  return (
    ...
    >
      <div className="font-semibold text-text-strong text-[13px] mb-0.5 flex items-start gap-1.5">
        ...
        <span className="opacity-0 group-hover:opacity-40 cursor-pointer text-[12px] shrink-0 mt-0.5 hover:!opacity-100 hover:text-danger transition-opacity" aria-label="Delete" onClick={(e) => { e.stopPropagation(); onDelete(n.ts) }}><X className="lucide-inline" /></span>
      </div>
