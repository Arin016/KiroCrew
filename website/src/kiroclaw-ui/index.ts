/**
 * @kiroclaw/ui — shared component library for KiroClaw apps.
 *
 ...
 * standalone package, the import map resolves `@kiroclaw/ui` to the
 * host's vendored copy — ensuring a single set of components and styles.
 *
 * Usage in apps:
 *   import { Card, Btn, Badge, PageHeader } from '@kiroclaw/ui'
 */
