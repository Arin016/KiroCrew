...
describe('PendingAttachments', () => {
  ...
  it('reports the dismissed path so the composer can drop it from state', () => {
    ...
    fireEvent.click(screen.getByLabelText('Remove attachment: b.png'))
  ...
  it('gives every chip its own accessible label', () => {
    ...
    expect(screen.getByLabelText('Remove attachment: a.png')).toBeTruthy()
    expect(screen.getByLabelText('Remove attachment: n.txt')).toBeTruthy()
  })
})
