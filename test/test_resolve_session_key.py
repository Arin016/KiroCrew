...
from kiro_claw.mcp_core import _get_ppid, _ppid_via_libproc, _resolve_session_key
...
class TestResolveSessionKey:
    ...
    def test_fresh_session_returns_env_without_walking_pids(self):
        ...
        (AcpClient._spawn sets KIROCLAW_SESSION_KEY), so resolution returns it
        ...
        with patch.dict(
            "os.environ", {"KIROCLAW_SESSION_KEY": "dashboard:chat-9-999"}
        ), patch("kiro_claw.mcp_core._get_ppid") as mock_ppid:
...
class TestGetPpid:
    ...
    def test_macos_prefers_libproc_over_ps(self):
        ...
        with patch("platform.system", return_value="Darwin"), patch(
            "kiro_claw.mcp_core._ppid_via_libproc", return_value=42
    ...
    def test_macos_falls_back_to_ps_when_libproc_yields_zero(self):
        ...
        with patch("platform.system", return_value="Darwin"), patch(
            "kiro_claw.mcp_core._ppid_via_libproc", return_value=0
