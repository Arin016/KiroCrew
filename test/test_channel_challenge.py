...
class TestSendChannelChallenge:
    ...
    async def test_posts_ephemeral_challenge(self):
        ...
        with patch("kiro_claw.slack.allowlist.KiroClawConfig") as mock_cfg, patch(
            ...
            "kiro_claw.slack.allowlist.dashboard_origin", return_value="http://localhost:5476"
        ), patch(
            "kiro_claw.slack.allowlist.parse_dashboard_url", return_value=("localhost", 5476)
        ), patch(
            ...
            mock_cfg.load.return_value.dashboard.url = "http://localhost:5476"
