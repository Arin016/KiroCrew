"""Tests for the api_kiroclaw_config PUT validator's max_subagents handling.
...
from kiro_claw.dashboard.handlers.core import api_kiroclaw_config
...
async def _put(agent_settings: dict, cfg_path) -> web.Response:
    ...
    with patch("kiro_claw.config.loader.config_path", return_value=cfg_path):
        return await api_kiroclaw_config(request)
