"""Schema registry for KiroClaw configuration.
...
def build_json_schema(root_cls: type) -> dict:
    ...
    # (KiroClawConfig itself doesn't have field metadata since it's the root)
    return schema
...
JSON_SCHEMA: dict = build_json_schema(KiroClawConfig)
