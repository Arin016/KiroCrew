...
from kiro_claw.knowledge.sync import SyncScheduler
...
def _create_embedder(app):
    """Create embedder from KiroClaw config. Returns None if disabled/unavailable."""
    cfg_path = Path.home() / ".kiroclaw" / "config.json"
    try:
