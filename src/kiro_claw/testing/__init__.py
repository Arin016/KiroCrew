...
- :mod:`kiro_claw.testing.fixtures` — ``seeded_home`` plain context manager
  ...
  ``$KIROCLAW_HOME`` from a named fixture.
- :mod:`kiro_claw.testing.harness` — ``spawn_feature_gateway`` context
...
``from kiro_claw.testing.harness import ...``); no top-level re-exports,
...
# can traverse paths like ``kiro_claw.testing.harness.TERMINATE_GRACE_SECONDS``
...
from kiro_claw.testing import fixtures, harness  # noqa: E402,F401
