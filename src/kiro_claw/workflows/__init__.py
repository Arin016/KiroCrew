"""Dynamic workflows for KiroClaw — the FROZEN CONTRACT (no implementation yet).
...
KiroClaw-native primitive wrappers — is built in parallel against this contract.
...
class WorkflowContext(Protocol):
    ...
    # --- KiroClaw-native (M4); None when not permitted for this run ---
