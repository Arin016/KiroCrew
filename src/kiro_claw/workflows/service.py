...
the same in-session model the rest of KiroClaw uses (no new model plumbing). It
...
_AUTHOR_SYSTEM = """\
You are authoring a KiroClaw DYNAMIC WORKFLOW: one Python module that orchestrates
