...
# ``kiro_claw.sel`` security event log; tests inject a capturing stub. Kept as a
...
class _RunContext:
    ...
    KiroClaw-native ports (cron/memory/learn/knowledge) are None until M4; ``agent``
    ...
    def __init__(
        ...
        *,
        ...
        # KiroClaw-native ports (M4) — injected per run; None when the host did
    ...
    # --- KiroClaw-native (M4): delegate to injected port fns; clear error if a
