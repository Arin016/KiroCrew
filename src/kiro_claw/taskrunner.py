...
from kiro_claw.task_executor import (
    build_task_prompt,
    execute_single_task,
    run_tests,
)
from kiro_claw.task_executor import self_review as self_review_fn

# ── Re-exports (preserve public API) ──
from kiro_claw.task_models import (  # noqa: F401
...
from kiro_claw.task_planner import (
    auto_name,
    decompose,
    decompose_yaml,
...
from kiro_claw.task_planner import plan_to_chat_context as _planner_plan_to_chat_context
from kiro_claw.task_planner import (
    update_plan_tasks,
)
from kiro_claw.task_reporter import (
