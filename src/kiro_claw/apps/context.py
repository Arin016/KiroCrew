...
from kiro_claw.apps.app_storage import AppStorage
...
class AppContext:
    ...
    logger: logging.Logger = field(default_factory=lambda: logging.getLogger("kiroclaw.app"))
...
def build_app_context(
    ...
    *,
    ...
    ctx_logger = logging.getLogger(f"kiroclaw.app.{app_name}")
