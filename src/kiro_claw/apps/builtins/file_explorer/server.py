...
APP_NAME = os.environ.get("KIROCLAW_APP_NAME", "file-explorer")
...
class FileExplorerHandler(BaseHTTPRequestHandler):
    ...
    def _dispatch(self, method: str) -> None:
        ...
        # KiroClaw's reverse proxy forwards requests as /api/<path>;
