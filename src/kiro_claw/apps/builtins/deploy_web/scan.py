...
Reuses KiroClaw's existing credential regexes (``security.get_credential_patterns()``)
...
try:  # reuse the canonical credential patterns (public accessor)
    from kiro_claw.security import get_credential_patterns

    _CRED = get_credential_patterns()
except ImportError:  # pragma: no cover - defensive
    logger.warning(
        "deploy-web: could not import credential patterns from kiro_claw.security; "
