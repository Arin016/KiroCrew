...
dashboard "Workflows" tab. KiroClaw proxies ``/apps/workflows/api/*`` to this
...
from kiro_claw.workflows.validate import validate
...
APP_NAME = os.environ.get("KIROCLAW_APP_NAME", "workflows")
