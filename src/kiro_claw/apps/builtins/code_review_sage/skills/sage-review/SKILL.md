...
```bash
python3 ~/.kiroclaw/apps/code-review-sage/sage_lib/learning.py list-for-review
```
...
cat ~/.kiroclaw/apps/code-review-sage/data/learnings/namespaces/<namespace>/learned-patterns.md 2>/dev/null
```
...
Write `~/.kiroclaw/apps/code-review-sage/data/results/<change-id>.json`. This is
