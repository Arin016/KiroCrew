...
Fully-populated `$KIROCLAW_HOME`: everything `minimal` ships **plus**
...
Running `kiroclaw gateway --seed rich` against a fresh `$KIROCLAW_HOME`
lands you on a dashboard where:

- **Sessions** panel shows 3 active slots: pinned **Welcome to KiroClaw**
...
│   ├── dashboard_coder-demo.jsonl     # pinned, kiroclaw agent, folder=demos, 8 msg
