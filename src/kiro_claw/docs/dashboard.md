...
- **Custom domain**: after `kiroclaw setup`, optionally use `http://kiroclaw.localhost:5476`
...
- **Agent Config**: edit the raw kiroclaw.json agent configuration
...
Browse, install, and manage KiroClaw apps. SSE streaming install logs show
