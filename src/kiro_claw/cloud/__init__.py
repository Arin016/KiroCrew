"""KiroClaw cloud launcher — provision + run KiroClaw on the user's own EC2.
...
- **Bring-your-own-AWS, store nothing.** Every AWS call shells to the ``aws``
  ...
  KiroClaw persists only a profile name, region, and stack name.
...
- ``templates/kiroclaw-ec2.yaml`` — the CloudFormation template.
"""

from __future__ import annotations

from kiro_claw.cloud.aws import AWSError, run_aws
