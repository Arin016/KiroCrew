...
#: wrong branch rather than a confusing message. REVIEW is 13 and not the free
#: 12 for exactly that reason -- 12 is already spoken for by a caller in this
#: pipeline, and a number whose meaning depends on which program printed it is
#: the defect this table exists to prevent. A gap costs one integer.
