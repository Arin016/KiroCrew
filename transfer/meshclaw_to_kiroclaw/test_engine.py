"""Tests for kiro_claw.meshclaw_migrate — MeshClaw → KiroClaw data migration."""
...
def homes(tmp_path, monkeypatch):
    """Point Path.home() at a tmp dir so both ~/.meshclaw and ~/.kiroclaw are sandboxed."""
    home = tmp_path / "home"
    home.mkdir()
