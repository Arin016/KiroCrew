"""Structured error types for kiroclaw-client."""
...
def http_error(status: int, body: Any = None) -> KiroClawError:
    ...
    return KiroClawError(code, message, status=status, body=body)
