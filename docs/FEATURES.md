...
Full-featured React SPA at `localhost:7777` (or `http://kiroclaw.localhost:7777`) with real-time updates.
...
**Dashboard CRUD**: create, edit, and delete skills from `localhost:7777` → Overview → Skills tab.
